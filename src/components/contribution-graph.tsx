...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        'data-[level="0"]:fill-bg-secondary/40',
        'data-[level="1"]:fill-bg-brand/30',
        'data-[level="2"]:fill-bg-brand/60',
        'data-[level="3"]:fill-bg-brand/80',
        'data-[level="4"]:fill-fg-brand/80',
        className
      )}
...
export const ContributionGraphCalendar = ({
  ...
  return (
    <div
      className={cn(
        "flex max-w-full flex-row-reverse overflow-x-auto overflow-y-hidden sm:block",
        className
      )}
      {...props}
    >
...
export const ContributionGraphTotalCount = ({
  ...
  return (
    <div className={cn("text-fg-tertiary", className)} {...props}>
      {labels.totalCount
        ? labels.totalCount
...
export const ContributionGraphLegend = ({
  ...
  return (
    <div
      className={cn("ml-auto flex items-center gap-[3px] text-sm", className)}
      {...props}
    >
      <span className="mr-1 text-fg-tertiary">
